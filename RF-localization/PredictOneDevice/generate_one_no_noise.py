# Step1: Hello World
# Fixed size room, one device, stationary, with no noise
import pandas as pd
import numpy as np
import random
import math
...
# Fixed SDR positions on TV (70 inch)
sdr_positions = [
...
df = generate_dataset(samples_per_device, noise=False)
df.to_csv(f"data/one_{samples_per_device}_no_noise.csv", index=False)